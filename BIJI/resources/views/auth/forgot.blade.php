                            ...
                            <div class="card-body p-4 text-center">
                                <div class="mt-2">
                                    ...
                                    <lord-icon src="https://cdn.lordicon.com/rhvddzym.json" trigger="loop"
                                        colors="primary:#e6b872" class="avatar-xl my-3"
                                        style="width:150px;height:150px;"></lord-icon>
                                    <p class="text-muted">Kami telah mengirimkan link untuk mengatur ulang kata sandi
                                        Anda. Silakan periksa email Anda dan klik link tersebut untuk melanjutkan proses
                                        reset kata sandi.</p>
                                </div>
                            </div>
                            <!-- end card body -->
